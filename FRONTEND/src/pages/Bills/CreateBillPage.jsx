      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
            <div>
              <label htmlFor=" BILL_NUMBER" className="block text-xs sm:text-sm font-medium text-gray-700">Bill Number <span className="text-red-500">*</span></label>
              <input
                type="text"
                id="billNumber"
                value={billNumber}
            ...
            <div>
              <label htmlFor="status" className="block text_xs sm:text-sm font-medium text-gray-700">Status <span className="text-red-500">*</span></label>
              <select
                id="status"
                value={status}
          ...
          {challanMode === 'challan' && (
            <div className="mt-4">
              <label htmlFor="challanId" className="block text-xs sm:text-sm font-medium text-gray-700">Select Unused Challan <span className="text-red-500">*</span></label>
              <select
                id="challanId"
                value={challanId}
              ...
              >
                <option value="">{availableChallans.length > 0 ? 'Select a challan' : 'No unused challans available'}</option>
              ...
              {isLoadingChallans && <p className="text-xs text-gray-500 mt-1">Loading unused challans...</p>}
            </div>
          )}
          {challanMode === 'manual' && (
            <div className="mt-4">
